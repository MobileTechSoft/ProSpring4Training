insert into contact (first_name, last_name, birth_date) values ('Thu', 'Schaefer', '1981-05-03');
insert into contact (first_name, last_name, birth_date) values ('Nam', 'Tiger', '1990-11-02');
insert into contact (first_name, last_name, birth_date) values ('Toan', 'Smith', '1964-02-28');
